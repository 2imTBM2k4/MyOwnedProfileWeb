    ...
    <div className="min-h-screen relative text-white flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 w-20 h-20 rounded-full border-4 border-cyan-500/20 border-t-cyan-500 animate-spin animation-delay-150" 
            style={{ animationDirection: 'reverse', animationDuration: '1s' }} />
        </div>

        {/* Loading text */}
        <div className="text-center">
          <h2 className="text-xl font-bold text-white mb-2 animate-pulse">{message}</h2>
          <p className="text-sm text-slate-400">Đang tải dữ liệu từ server</p>
        </div>
